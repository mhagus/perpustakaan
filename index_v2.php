...
<head>
    ...
    <title>Sistem Perpustakaan - Versi 2</title>
    <style>
        body {
...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Muhammad Agus (60324026)"; ?></p>
            <p><strong>Tanggal:</strong> <?php echo date('d F Y'); ?></p>
            <p><strong>Waktu Server:</strong> <?php echo date('H:i:s'); ?></p>
        </div>

        <?php
        // --- Konfigurasi Data Perpustakaan ---
        $nama_perpus    = "Perpustakaan Universitas ABC";
        $alamat_perpus  = "Jl. Gajah Mada No. 123, Semarang";
        $telepon_perpus = "(024) 8451234";
        $jam_buka       = "08:00";
        $jam_tutup      = "16:30";
        ...
        // Poin 5: Perhitungan persentase ketersediaan
        ...
        <div class="perpus-info">
            ...
            <p><strong>Hari Libur:</strong> <span style="color: #d32f2f; font-weight: bold;"><?php echo $hari_libur; ?></span></p>
        </div>

        <div class="info">
            <h3>📊 Statistik <?php echo $nama_perpus; ?></h3>
            <p><strong>Total Buku:</strong> <?php echo number_format($total_buku); ?> unit</p>
            <p><strong>Total Anggota:</strong> <?php echo number_format($total_anggota); ?> orang</p>
            <p><strong>Sedang Dipinjam:</strong> <?php echo $buku_dipinjam; ?> (<?php echo $persen_pinjam; ?>%)</p>
            
            <p><strong>Tersedia:</strong> <?php echo number_format($buku_tersedia); ?> unit (<?php echo $persen_tersedia; ?>%)</p>
        </div>
